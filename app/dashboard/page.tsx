            ...
            <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-6 sticky top-24">
              ...
              <nav className="space-y-1">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all text-red-600 hover:bg-red-50 mt-4 border-t border-slate-200 pt-4"
                >
              ...
              >
                ...
                <div className="mb-8">
                  ...
                  <p className="text-slate-600">
                    Таны бүртгэлийн хянах самбарт тавтай морил
                  </p>
                </div>
                  ...
                  <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="w-12 h-12 bg-red-50 rounded-xl flex items-center justify-center">
                        <Heart className="w-6 h-6 text-red-600" strokeWidth={2} />
                      </div>
                  ...
                  <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center">
                        <ShoppingBag className="w-6 h-6 text-blue-600" strokeWidth={2} />
                      </div>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                  ...
                  {orders.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <Link href="/">
                        <button className="mt-4 px-6 py-2.5 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-full font-medium hover:from-orange-600 hover:to-orange-700 transition-all">
                          Худалдан авалт хийх
                        </button>
                      </Link>
                    </div>
              ...
              >
                ...
                {orders.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <Link href="/">
                      <button className="px-6 py-2.5 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-full font-medium hover:from-orange-600 hover:to-orange-700 transition-all">
                        Худалдан авалт хийх
                      </button>
                    </Link>
                  </div>
                  ...
                  <div className="space-y-4">
                    {orders.map((order) => (
                      <div
                        key={order.id}
                        className="p-6 border border-slate-200 rounded-xl hover:border-orange-300 transition-colors"
                      >
